...
**Last updated:** review 072 (2026-08-18); F74 fix returned for two gaps, F76 opened, Gate D blocked on F44 + F74
...
**Gate D's blocker count goes back from one to two: F44 and F74.** F44 remains
upstream and un-waivable; F74 is ours and actionable, and it needs a design
decision from the architect before any fix — recorded in its register entry —
because the obvious repair (recurse and digest every subtree) is a performance
decision disguised as a bug fix.
